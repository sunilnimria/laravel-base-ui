    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            ...
            <div class="ms-md-auto py-2 py-md-0">
                ...
                <a href="{{route('settings.create')}}" class="btn btn-primary btn-round">Update Setting</a>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="indonesia" />
                                                    </div>
                                                </td>
                                                <td>Indonesia</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="united states" />
                                                    </div>
                                                </td>
                                                <td>USA</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="australia" />
                                                    </div>
                                                </td>
                                                <td>Australia</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="russia" />
                                                    </div>
                                                </td>
                                                <td>Russia</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="china" />
                                                    </div>
                                                </td>
                                                <td>China</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('storage/' . Auth::user()->avatar)}}" alt="brazil" />
                                                    </div>
                                                </td>
                                                <td>Brasil</td>
