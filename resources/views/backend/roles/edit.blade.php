<x-modal.modalHeader modalTitle="Edit Tag" />
...
<div class="modal-body">
    ...
    <form id="modalForm" class="storeData" action="{{ route('roles.update', $role->id) }}"
        method="POST">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-12">
                ...
                <x-form.input type="text" id="name" name="name" :value="$role->name"
